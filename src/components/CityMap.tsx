...
// Декоративна 3D градска мапа на Гостивар со кликабилни пинови на профили.
// Се прикажува само на десктоп (на дното на почетната).
export default function CityMap() {
  ...
  return (
    <div
      className="hidden lg:block relative w-full h-[460px] rounded-[2rem] bg-gradient-to-b from-white via-white to-slate-100 overflow-hidden border border-slate-200/80 shadow-2xl shadow-slate-300/40 ring-1 ring-white"
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Река Вардар */}
          <path d="M-40 120 C 200 180, 260 300, 480 340 S 820 420, 1080 380" stroke="#7dd3fc" strokeWidth="26" strokeLinecap="round" opacity="0.8" />
          <path d="M-40 120 C 200 180, 260 300, 480 340 S 820 420, 1080 380" stroke="#38bdf8" strokeWidth="10" strokeLinecap="round" opacity="0.5" />
